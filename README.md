...
<p><ul style="padding-left:20px">
  ...
  <li>Uses OpenMP to spread horizontal and vertical pass across many threads. Around ~30% uplift since image-resampling has low arithmetic intensity (memory bandwidth bound). Mileage may vary on different problem sizes due to weak-scaling.</li>
</ul>
